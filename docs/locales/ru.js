export default {
    ...
    optsNavTitles: 'Шаблоны заголовков в навигации календаря. Можно использовать HTML теги и символы из {formatDateField}.',
    optsNavTitles2: 'Значения по умолчанию:',
    optsNavTitles3: 'Применение:',
    optsTimepicker: '',
    optsOnlyTimepicker: '',
    optsTimeFormat: '',
    optsMinHours: '',
