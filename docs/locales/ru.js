export default {
    ...
    optsTimeFormat: 'Формат времени. Так же как и {dateFormatField} опирается на {standardLink}.',
    optsTimeFormath: 'часы',
    optsTimeFormathh: 'часы с лидирующим нулем',
    optsTimeFormatm: 'минуты',
    optsTimeFormatmm: 'минуты с лидирующим нулем',
    optsTimeFormataa: 'период дня маленькими буквам',
    optsTimeFormatAA: 'период дна заглавными буквами',
    optsMinHours: '',
    optsMaxHours: '',
    optsMinMinutes: '',
    optsMaxMinutes: '',
